...
foreign_id = 'ng_national_assembly_bills'
collection = api.load_collection_by_foreign_id(foreign_id)
collection_id = collection.get('id')

bills = "https://www.nassnig.org/documents/bill_track/"
docs_url = "https://www.nassnig.org/documents/download/"

response = requests.get(bills)
doc_json = response.json()
docs = doc_json['data']

folder_location = './bills'
for doc in docs:
